...
import myntralogo from '../image/Images/tt11.png';

export const Header = () => {
    return (
        <div className="flex h-[80px] ">
            <div className="w-[10%] flex justify-center items-center">
                <img className="h-[50px]" src={myntralogo} alt="myntraLogo" ></img>
            </div>
            <div className="w-[50%] flex  flex-row  items-center">
                ...
                <div className="px-[10px] cursor-pointer"><a className="font-bold">STUDIO</a></div>
            </div>
            <div className="w-[25%] flex justify-center items-center relative">
                ...
                <input className="h-[50%]  w-[95%] bg-[#F5F5F6] rounded pl-[25px] focus:bg-[white] focus:outline-none focus:border-[2px]" type="text" placeholder="Search for products , brands and many more." />
            </div>
